...
function CreatePage(props: any) {
  const {
    ...
    line127,
    serviceFee25,
    tipMarkdownSyntaxIsSupported,
    youWillReceive0Eth000,
    putOnSale,
    instantSalePrice,
    text4,
    text5,
      ...
      <div className="desktop-44 screen">
        <div className="overlap-group">
          ...
          <div className="group-932">
            ...
            <div className="go-back mulish-extra-bold-black-16px">{goBack}</div>
          </div>
        </div>
        ...
        <div className="overlap-group2">
          ...
          <div className="group-944">
            <div className="choose-file">{chooseFile}</div>
            <div className="group-206-1">
              <div className="overlap-group3-2">
                <img className="vector-3-1" src={vector32} />
                <img className="line-35-1" src={line352} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="group-930">
          <div className="overlap-group5">
            <div className="create-item">{createItem}</div>
          </div>
        </div>
      </div>
    </div>
